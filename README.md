...
Install from the Firefox extension store: [https://addons.mozilla.org/en-US/firefox/addon/youtube-fullscreen-anywhere/](https://addons.mozilla.org/en-US/firefox/addon/youtube-fullscreen-anywhere/)
